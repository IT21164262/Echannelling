			  ...
			  <div class="container-fluid">
			    <div class="row">
			      <div class="col-sm-6 px-0 d-none d-sm-block">
			        <img src="image/docterlogin.jpg" alt="Login image" class="w-100 vh-100" style="opacity: 0.6;object-fit: cover; object-position: left;box-sizing: 1px">
			      </div>
			        ...
			        <div class="d-flex justify-content-center">
			          ...
			          <form action="Login" method="post" style="width: 85%;">
			            ...
			            <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Doctor Log in</h3>
			            ...
			            <div class="pt-1 mb-4">
			            	<input class="btn btn-outline-primary" type="submit" name="DoctorLogin" value="&nbsp;&nbsp;Login&nbsp;&nbsp;">
